...
def variance_nozzle():
    ...
    # machine_name → (ingredient, volume)
    ...
    # --- POS sales (map to ingredient, sum across stores) ---
    cur.execute("""
        SELECT plu_code, store_id, quantity
        FROM sales_transactions
    ...
    # --- Machine sales (map to ingredient, sum across stores) ---
    cur.execute("""
